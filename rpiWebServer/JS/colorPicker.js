class Picker {
  constructor(target, width, height) {
      ...
      //Picker circle object.
      this.pickerCircle = {x:10,y:10,width:7,height:7};

      // Listens for events on created instance of the object
  ...
  build(){
    ...
    //Apply back and white to the gradient.
...
let picker1 = new Picker(document.getElementById("color-picker"),250,220);

//Call to draw the Canvas
setInterval(() => picker1.draw(), 1);
...
picker1.onChange((color) => {
  ...
  setColorInputs(color.r,color.g,color.b);
});

function setColorInputs(red = 0,green = 0,blue = 0){
  document.getElementById("red").value = red;
  document.getElementById("green").value = green;
  document.getElementById("blue").value = blue;
  document.body.style.backgroundColor = `rgb(${red},${green},${blue})`
  document.main.style.backgroundColor = `rgb(${red},${green},${blue})`
  // document.body.style.backgroundColor = 'red'
  // document.main.style.backgroundColor = 'red'
}
